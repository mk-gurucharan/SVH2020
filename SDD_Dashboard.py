...
class SocialDistanceAnalysis:
    ...
    def SDASetup(self, yolopath, assetpath, videoShape):
        if self.setup:
            ...
            cv2.putText(self.blankDashboard, "SmartSocial", (20,10), cv2.FONT_HERSHEY_SIMPLEX, 0.4, (0, 0, 0), 1)
            cv2.putText(self.blankDashboard, "Social Distance Monitoring App", (20,30), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 0, 0), 1)
            cv2.putText(self.blankDashboard, "Team Apocalpyse", (10,45), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 0), 1)
...
opname = "outputs/output_" + filename.split('/')[1][:-4] + '.mp4'
